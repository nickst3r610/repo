...
var desktop = new RoomObject('Desktop', 'Wooden table with a drawer', ['BlueKey'], ['RedKey'], 'use')
var door = new RoomObject('Door', 'Completely shut', [], [], 'use')
var cabinet = new RoomObject('Cabinet', 'Roach infested', ['RedKey'], ['Raid'], 'use')
var fridge = new RoomObject('Fridge', 'LG new touch screen fridge', ['snack'], [], 'use')
var table = new RoomObject('Table', 'Wooden table with fancy silverware', ['Raid'], [], 'use')
var window = new RoomObject('Window', 'The street looks nice', [], ['BlueKey'], 'use')
var horrorRoomObjects = []
horrorRoomObjects.push(desktop, door, cabinet, fridge, table, window)
...
var room = new Room(horrorRoomObjects)
var rooms = []
rooms.push(room)
/**
